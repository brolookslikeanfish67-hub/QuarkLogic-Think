...
# launch args for multi-node (set in script or in bash)
# TODO set here or in the bash command (MASTER_ADDR=... RANK=... bash run/multinode_benchmark_farskip_deepseek_v3.sh)
#export RANK
#export MASTER_ADDR=<node0_ip>:port


MODEL_PATH="./checkpoint_configs/deepseek_v3"
PROFILE_DIR="./traces/benchmark_deepseek_v3/multi_node" # optional profile trace directory
